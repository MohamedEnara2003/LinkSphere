...
<section class="w-full min-h-svh flex items-center justify-center p-5">
  <form 
    ...
    <nav class="flex justify-center items-center mt-2" aria-label="Auth-redirect-link" role="navigation">
      <p class="ngText font-light">Didn't receive code?</p>
      <button type="button" aria-label="Reset otp link" role="link"
