...
<span class="md:sr-only text-[10px]">{{ 'navigation.home' | translate }}</span>
</a>
</li>
...
<span class="md:sr-only text-[10px]">{{ 'navigation.friends' | translate }}</span>
</a>
</li>
...
<span class="md:sr-only text-[10px]">{{ 'navigation.profile' | translate }}</span>
</a>
</li>

<li [title]="'navigation.chats' | translate">
...
<span class="md:sr-only text-[10px]">{{ 'navigation.chats' | translate }}</span>
</a>
</li>

<li [title]="'navigation.settings' | translate">
...
<span class="md:sr-only text-[10px]">{{ 'navigation.settings' | translate }}</span>
</a>
</li>
